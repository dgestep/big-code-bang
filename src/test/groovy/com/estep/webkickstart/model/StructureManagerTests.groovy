...
class StructureManagerTests extends GroovyTestCase {
    ...
    void testCreateModelStructure() {
        ...
        assertConfigPathsExist(render("model.base.path"), true)
        ...
        assertConfigPathsExist(render("model.base.path"), false)
    }
    ...
    private void copyCheckstyle() {
        String destination = render("model.base.path") + File.separator + "config" + File.separator + "checkstyle/proj-checkstyle.xml"
    ...
    private void copyPmd() {
        String destination = render("model.base.path") + File.separator + "config" + File.separator + "rulesets/proj-pmd-rules.xml"
    ...
    private void assertConfigPathsExist(path, exists) {
        assertPath(path, exists)

        assertPath(path + File.separator + "config" + File.separator + "checkstyle", exists)
        assertPath(path + File.separator + "config" + File.separator + "rulesets", exists)
    }
