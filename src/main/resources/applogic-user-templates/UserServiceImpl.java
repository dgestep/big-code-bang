...
import com.${companyName}.${productName}.model.repository.mail.MailRepository;
import com.${companyName}.${productName}.model.repository.user.PasswordGeneratorRepository;
...
import com.${companyName}.${productName}.model.repository.user.UserCredentialValidator;
...
import com.${companyName}.${productName}.model.service.SecurityHelper;
import com.${companyName}.${productName}.model.service.lookup.LookupKeyValueService;
